...
class JsiSkDOM {
  ...
  LinearToSRGBGammaColorFilter() {
    return this.native ? global.SkiaDomApi.LinearToSRGBGammaColorFilterNode() : new _ColorFilters.LinearToSRGBGammaColorFilterNode(this.ctx);
  }
  SRGBToLinearGammaColorFilter() {
    return this.native ? global.SkiaDomApi.SRGBToLinearGammaColorFilterNode() : new _ColorFilters.SRGBToLinearGammaColorFilterNode(this.ctx);
  }
