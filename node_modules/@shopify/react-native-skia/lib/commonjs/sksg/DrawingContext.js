...
const computeClip = (Skia, clip) => {
  if (clip) {
    ...
    } else if ((0, _types2.isRRect)(clip)) {
      return {
        clipRRect: clip
      };
    } else {
...
class DrawingContext {
  ...
  processPaint({
    ...
    if (blendMode !== undefined) {
      paint.setBlendMode(_types2.BlendMode[(0, _nodes.enumKey)(blendMode)]);
    }
    if (style !== undefined) {
      paint.setStyle(_types2.PaintStyle[(0, _nodes.enumKey)(style)]);
    }
    if (strokeJoin !== undefined) {
      paint.setStrokeJoin(_types2.StrokeJoin[(0, _nodes.enumKey)(strokeJoin)]);
    }
    if (strokeCap !== undefined) {
      paint.setStrokeCap(_types2.StrokeCap[(0, _nodes.enumKey)(strokeCap)]);
    }
  ...
  processMatrixAndClipping(props, layer) {
    ...
    const op = props.invertClip ? _types2.ClipOp.Difference : _types2.ClipOp.Intersect;
    const m3 = (0, _nodes.processTransformProps2)(this.Skia, props);
